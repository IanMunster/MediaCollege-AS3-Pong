package
{
	...
	public class Main extends MovieClip 
	{
		...
		private var configGame:ConfigScreen;
		...
		{			
			...
			introScreen.addEventListener(IntroScreen.CONFIG_SCREEN, Config);
		}
		private function Config(e:Event):void
		{
			removeChild(introScreen);
			configGame = new ConfigScreen();
			addChild(configGame);
			configGame.addEventListener(ConfigScreen.START_GAME, startGame);
		}
		private function startGame(e:Event):void 
		{
			removeChild(configGame);
